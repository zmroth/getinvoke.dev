...
author: Zach Roth
layout: post
excerpt: "Wispr Flow is $120/year. Voicy is $102/year. Here's what you can use instead for a one-time payment — or free."
...
Voice dictation is an input method. Like a keyboard. Like a mouse. You buy a keyboard once and it works until it breaks. The idea that I should pay $10 or $12 every month for the rest of my career to speak into my computer doesn't sit right with me.
...
After five months, Wispr Flow has already cost more than Invoke. After two years, you've paid $240 for the same thing you could have bought once for $49.
...
Totally different kind of tool. Talon is a full voice control system, not just dictation. You learn a grammar of voice commands to navigate your editor, write code, control your computer. Steep learning curve — weeks to get comfortable. But it's free, open source, and runs on everything.
...
The counter-argument is that your own GPU can do the same thing for free. Whisper is open source. The model weights are public. You already own the hardware. You're paying Wispr $120/year to use a cloud copy of a model you could run locally.
...
If you dictate regularly, you'll use this tool for years. A $10/month subscription costs $600 over five years. Invoke costs $49.

You can spend that $551 difference on something else. Or just keep it.
